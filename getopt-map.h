...
#define _id_default_footer_  _idm_( _lim_sup ),           \
                             ...
                             _idm_( _opt_unknown ),       \
                             _idm_( _opt_missing ),       \
                             _idm_( _opt_uninitialized ), \
                             _idm_( _opt_unhandled ),     \
                             _idm_( _opt_iteration ),     \
                                                          \
...
#define _opl_(x,str,is_needed)  { str, _##is_needed##_argument, 0, _id_(x) }
...
#if defined( GETOPT_FILE_TRANSLATIONS ) && ! defined( GETOPT_AVOID_BLOAT )
...
#if defined( GETOPT_FILE_TRANSLATIONS )
